...
// MLL - imported the data route for assignment 1, but changed it so that you can only use it if you're authenticated 
...
module.exports = function(passport) {
	...
	router.get('/data', isAuthenticated, function(req, res, next) {
	  IntoxicationDeaths.find({}, {_id: 0}, function(err, data){
